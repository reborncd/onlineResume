<template>
  <div
    ...
    <Iconfont
      ...
      name="Basketball" />
    <Iconfont
      class="size-12 absolute left-0 top-0 transition-all duration-500 rotate-[10deg] translate-x-4 group-hover:left-0 group-hover:rotate-[360deg] group-hover:scale-[1.35]"
      :size="30"
      name="Sport-T-shirt-g" />
  </div>
</template>
